...
#SBATCH --output=/data/users/sjaegers/assembly_annotation_course/output/output_genespaceAll_%j.o
#SBATCH --error=/data/users/sjaegers/assembly_annotation_course/error/error_genespaceAll_%j.e
#SBATCH --partition=pall

#Specify directory structure and create them
    BASE=/data/users/sjaegers/assembly_annotation_course
        GENESPACE=$BASE/12_Genespace_all
        SCRIPT=$BASE/scripts
