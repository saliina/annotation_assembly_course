...
#SBATCH --output=/data/users/sjaegers/assembly_annotation_course/output_merqury_evaluation_%j.o
#SBATCH --error=/data/users/sjaegers/assembly_annotation_course/error_merqury_evaluation_%j.e
