...
genome=/data/users/sjaegers/assembly_annotation_course/04_Polish/Pilon/Flye/flye.fasta (fasta file or fasta embeded in GFF3 file)
...
est=/data/users/sjaegers/assembly_annotation_course/03_Assembly/Trinity/Trinity.fasta #set of ESTs or assembled mRNA-seq in fasta format
...
rmlib=/data/users/sjaegers/assembly_annotation_course/07_Annotation/EDTA/flye.fasta.mod.EDTA.TElib.fa #provide an organism specific repeat library in fasta format for RepeatMasker
